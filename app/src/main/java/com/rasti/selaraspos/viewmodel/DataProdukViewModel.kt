...
class DataProdukViewModel : ViewModel() {
    ...
    private val allProdukList = mutableListOf<ModelProduk>()
    ...
    fun getData() {
        ...
        listener = object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                _produkList.value = allProdukList.toList()
    ...
    fun filterList(query: String) {
        ...
        // Filter berdasarkan nama dan kategori saja
        val filtered = allProdukList.filter { produk ->
            val namaMatch = produk.namaProduk.contains(query, ignoreCase = true)
            val kategoriMatch = produk.kategoriProduk.contains(query, ignoreCase = true)
